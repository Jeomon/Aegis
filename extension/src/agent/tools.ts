...
export const TOOL_GUIDELINES = [
  ...
  '',
  'A field showing value=[redacted:kind#n] holds a secret you are not shown. To reuse it,',
  'pass that handle verbatim as the text — it is restored on the device, and only into a',
